...
# print(p1)
# p1.display_info()
print(p1.display_info())   # 값으로 평가될 수 있는 표현식 / 함수를 실행했으니 return의 default인 None도 반환

inst1 = Product('작은메아리', 3200)
inst2 = Product('초코소라빵', 2800)

print(inst1, inst1.display_info())
print(inst2, inst2.display_info())
